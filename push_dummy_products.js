...
async function update() {
    try {
        const url = "https://adis-fashion-default-rtdb.firebaseio.com/products.json";
        ...
        console.log("Successfully pushed", data.length, "dummy products to Firebase!");
    } catch(err) {
        console.error("Failed to push products:", err);
    }
}
update();
